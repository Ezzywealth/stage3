	...
	return (
		<section className='bg-black/50 w-full h-screen px-4 flex items-center justify-center'>
			<section className=' bg-white flex flex-col text-gray-600 items-center w-full md:w-[600px] px-3 md:px-6 py-6 md:py-12'>
				...
				<h1 className='text-3xl font-bold text-center mb-10 text-gray-600'>Ziks Gallery</h1>
				<form className='space-y-6 mb-10  w-full rounded-md  z-[10000]' onSubmit={handleSubmit(handleSignIn)}>
					<div>
						<label className='block mb-2 text-base font-semibold text-[#121212]'>E-mail</label>
						<input
							defaultValue={email}
							type='email'
							id='email'
							...
							className={` border border-gray-300  text-[#121212] sm:text-sm rounded-lg focus:outline-none focus:ring-0 block w-full p-4  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
							placeholder='E-mail'
						/>
					...
					<div className=''>
						<label className='block mb-2 text-sm font-medium text-[#121212]'>Password</label>
						<input
							...
							id='password'
							placeholder='••••••••'
							className={` border border-gray-300 text-[#121212]  sm:text-sm rounded-lg focus:border-my-primary focus:border-2 focus:outline-none focus:ring-0 block w-full p-4 dark:focus:ring-blue-500 dark:focus:border-blue-500`}
						/>
